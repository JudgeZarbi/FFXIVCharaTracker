...
namespace FFXIVCharaTracker.Migrations
{
    ...
    [Migration("20230127172737_InventorySlotRemoveSortCategory")]
    partial class InventorySlotRemoveSortCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FFXIVCharaTracker.DB.InventorySlot", b =>
                {
                    ...
                    b.HasIndex("ItemCategory", "ItemID", "CharaID");

                    b.HasIndex("ItemCategory", "ItemID", "RetainerID");
